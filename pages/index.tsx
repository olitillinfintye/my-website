...
export default function Home() {
  ...
  const meta = {
    title: "oliyad tesfaye - Software Engineer",
    description: `I've been working on AR, Game and softwere development for 5 years straight. Get in touch with me to know more.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://oliyadtesfaye.onrender.com`} />
        <link rel="canonical" href={`https://oliyadtesfaye.onrender.com`} />
      ...
      {!isBlackListed ? (
        <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
          ...
          {context.sharedState.finishedLoading ? (
            <Footer githubUrl={"https://github.com/olitillinfintye/my-website"} hideSocialsInDesktop={true} />
          ) : (
            <></>
          )}
